    ...
    return (
        <div className='flex flex-col child-container gap-5'>
            ...
            <div className="w-full h-full mb-5">
                <h2 className='title-2 mb-5 underline'>Mallow Technologies</h2>
                <h3 className='title-3 mb-2'>Developer <span className='text-white'>|</span> Apr 2023 to Feb 2024</h3>
                ...
                <h3 className='title-3 mb-1'>Junior Developer <span className='text-white'>|</span> Apr 2022 to Mar 2023</h3>
                <ul className='list-disc list-inside text-white mb-5'>
                ...
                <h3 className='title-3 mb-1'>Developer Trainee <span className='text-white'>|</span> Oct 2021 to Mar 2022</h3>
                <ul className='list-disc list-inside text-white mb-5'>
                ...
                <h3 className='title-3 mb-1'>Developer Intern <span className='text-white'>|</span> Apr 2021 to Sept 2022</h3>
                <ul className='list-disc list-inside text-white mb-5'>
                    <li>Developed a comprehensive documentation site</li>
                    <li>Collaborated with content and design teams to extract valuable insights and content</li>
                    <li>Ensured seamless user experience and accessibility</li>
